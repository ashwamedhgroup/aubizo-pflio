...
import { home as homeContent, services as servicesContent } from '../data/siteContent'
...
export function ServicesPage() {
  const { title, description, heroBadge, heroSubline, items } = servicesContent
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <p className="text-center text-sm font-medium text-zinc-500">Choose a capability to see scope, fit, and next steps.</p>
              ...
              <li key={s.id}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-3 line-clamp-3 flex-1 text-sm leading-relaxed text-zinc-600">{s.excerpt}</p>
      ...
      <section className="border-t border-zinc-200 bg-gradient-to-b from-zinc-100/80 to-zinc-50 py-16">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold tracking-tight text-zinc-900 sm:text-3xl">Not sure which service fits?</h2>
          <p className="mt-4 text-zinc-600">
            Tell us how you operate today — we’ll recommend a practical path, whether that’s Aubizo, a custom build, or a
            phased rollout.
          </p>
